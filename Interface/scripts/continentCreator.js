...
var home = document.getElementById("homeSelector");
...
element.addEventListener("change", (e) => {
    ...
    const homeCountry = home.options[home.selectedIndex].text;
    const ageSent = age.value;
    const timeSent = time.value;
    if (value) {
      countryInput=value;
      homeInput=homeCountry;
      makingShape(countryInput);
      calculatingInitialCE(countryInput,homeCountry,ageSent,timeSent);
    } else {
